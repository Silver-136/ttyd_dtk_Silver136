...
s32 battle_evt_majo_disp_on(void* evt, s32 isFirstCall) {
    ...
    if (isFirstCall != 0) {
        ...
        *(s32*)((s32)evt + 0x80) = 0;
        *(s32*)((s32)evt + 0x84) = 0;
        pos = *(MajoDispPos*)((s32)unit + 0xEC);
        pos.x = x;
        pos.y = y - float_200_80424228;
        pos.z = z;
        *(MajoDispPos*)((s32)unit + 0x3C) = pos;
