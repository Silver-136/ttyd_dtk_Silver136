...
void yuugijou_init(void) {
    ...
    *(s32*)(w + 0xF8) = 0x1B;
    *(s32*)(w + 0xFC) = 0x8A;
    rank = ((700 - *(s32*)(w + 0xEC)) * 15) / 700;
    if (rank < 0)
        rank = 0;
    *(s32*)(w + 0x1AC) = rank + 1;
    rank = ((700 - *(s32*)(w + 0xF0)) * 15) / 700;
    if (rank < 0)
        rank = 0;
    *(s32*)(w + 0x1B0) = rank;
    rank = ((700 - *(s32*)(w + 0xF4)) * 15) / 700;
    if (rank < 0)
        rank = 0;
    *(s32*)(w + 0x1B4) = rank;
    rank = ((700 - *(s32*)(w + 0xF8)) * 15) / 700;
    if (rank < 0)
        rank = 0;
    *(s32*)(w + 0x1B8) = rank;
    rank = ((700 - *(s32*)(w + 0xFC)) * 15) / 700;
    if (rank < 0)
        rank = 0;
    *(s32*)(w + 0x1BC) = rank;
    ...
    *(s32*)(w + 0x110) = 0x1F91E;
    *(s32*)(w + 0x114) = 0x1E3AC;
    rank = (*(s32*)(w + 0x104) - 0x1A9C8) / 2000;
    if (rank < 0)
        rank = 0;
    *(s32*)(w + 0x1C4) = rank + 7;
    rank = (*(s32*)(w + 0x108) - 0x1A9C8) / 2000;
    if (rank < 0)
        rank = 0;
    *(s32*)(w + 0x1C8) = rank + 6;
    rank = (*(s32*)(w + 0x10C) - 0x1A9C8) / 2000;
    if (rank < 0)
        rank = 0;
    *(s32*)(w + 0x1CC) = rank + 4;
    rank = (*(s32*)(w + 0x110) - 0x1A9C8) / 2000;
    if (rank < 0)
        rank = 0;
    *(s32*)(w + 0x1D0) = rank + 4;
    rank = (*(s32*)(w + 0x114) - 0x1A9C8) / 2000;
    if (rank < 0)
        rank = 0;
    *(s32*)(w + 0x1D4) = rank + 1;
    ...
    *(s32*)(w + 0x128) = 0x1627E;
    *(s32*)(w + 0x12C) = 0x15950;
    rank = (*(s32*)(w + 0x11C) - 74000) / 2000;
    if (rank < 0)
        rank = 0;
    *(s32*)(w + 0x1DC) = rank + 7;
    rank = (*(s32*)(w + 0x120) - 74000) / 2000;
    if (rank < 0)
        rank = 0;
    *(s32*)(w + 0x1E0) = rank + 6;
    rank = (*(s32*)(w + 0x124) - 74000) / 2000;
    if (rank < 0)
        rank = 0;
    *(s32*)(w + 0x1E4) = rank + 4;
    rank = (*(s32*)(w + 0x128) - 74000) / 2000;
    if (rank < 0)
        rank = 0;
    *(s32*)(w + 0x1E8) = rank + 3;
    rank = (*(s32*)(w + 0x12C) - 74000) / 2000;
    if (rank < 0)
        rank = 0;
    *(s32*)(w + 0x1EC) = rank + 4;
    ...
    *(s32*)(w + 0x158) = 0x1B;
    *(s32*)(w + 0x15C) = 0x8A;
    rank = ((700 - *(s32*)(w + 0x14C)) * 15) / 700;
    if (rank < 0)
        rank = 0;
    *(s32*)(w + 0x20C) = rank + 1;
    rank = ((700 - *(s32*)(w + 0x150)) * 15) / 700;
    if (rank < 0)
        rank = 0;
    *(s32*)(w + 0x210) = rank;
    rank = ((700 - *(s32*)(w + 0x154)) * 15) / 700;
    if (rank < 0)
        rank = 0;
    *(s32*)(w + 0x214) = rank;
    rank = ((700 - *(s32*)(w + 0x158)) * 15) / 700;
    if (rank < 0)
        rank = 0;
    *(s32*)(w + 0x218) = rank;
    rank = ((700 - *(s32*)(w + 0x15C)) * 15) / 700;
    if (rank < 0)
        rank = 0;
    *(s32*)(w + 0x21C) = rank;
    ...
    *(s32*)(w + 0x170) = 0x1D5BA;
    *(s32*)(w + 0x174) = 0x1C1CE;
    rank = (*(s32*)(w + 0x164) - 0x1A9C8) / 2000;
    if (rank < 0)
        rank = 0;
    *(s32*)(w + 0x224) = rank + 7;
    rank = (*(s32*)(w + 0x168) - 0x1A9C8) / 2000;
    if (rank < 0)
        rank = 0;
    *(s32*)(w + 0x228) = rank + 6;
    rank = (*(s32*)(w + 0x16C) - 0x1A9C8) / 2000;
    if (rank < 0)
        rank = 0;
    *(s32*)(w + 0x22C) = rank + 4;
    rank = (*(s32*)(w + 0x170) - 0x1A9C8) / 2000;
    if (rank < 0)
        rank = 0;
    *(s32*)(w + 0x230) = rank + 4;
    rank = (*(s32*)(w + 0x174) - 0x1A9C8) / 2000;
    if (rank < 0)
        rank = 0;
    *(s32*)(w + 0x234) = rank + 1;
    ...
    *(s32*)(w + 0x188) = 0x149A6;
    *(s32*)(w + 0x18C) = 0x14122;
    rank = (*(s32*)(w + 0x17C) - 74000) / 2000;
    if (rank < 0)
        rank = 0;
    *(s32*)(w + 0x23C) = rank + 7;
    rank = (*(s32*)(w + 0x180) - 74000) / 2000;
    if (rank < 0)
        rank = 0;
    *(s32*)(w + 0x240) = rank + 6;
    rank = (*(s32*)(w + 0x184) - 74000) / 2000;
    if (rank < 0)
        rank = 0;
    *(s32*)(w + 0x244) = rank + 4;
    rank = (*(s32*)(w + 0x188) - 74000) / 2000;
    if (rank < 0)
        rank = 0;
    *(s32*)(w + 0x248) = rank + 3;
    rank = (*(s32*)(w + 0x18C) - 74000) / 2000;
    if (rank < 0)
        rank = 0;
    *(s32*)(w + 0x24C) = rank + 4;
}
