...
void yuugijou_init(void) {
    ...
    *(s32*)((u8*)yuwp + 0xFC) = 0x8A;
    rank = ((700 - *(s32*)((u8*)yuwp + 0xEC)) * 15);
    rank = rank / 700 + (rank >> 31);
    rank = rank - (rank >> 31);
    *(s32*)((u8*)yuwp + 0x1AC) = ((u32)rank & -((s32)(u32)rank >> 31) - 1U) + 1;
    rank = ((700 - *(s32*)((u8*)yuwp + 0xF0)) * 15);
    rank = rank / 700 + (rank >> 31);
    rank = rank - (rank >> 31);
    *(s32*)((u8*)yuwp + 0x1B0) = ((u32)rank & -((s32)(u32)rank >> 31) - 1U);
    rank = ((700 - *(s32*)((u8*)yuwp + 0xF4)) * 15);
    rank = rank / 700 + (rank >> 31);
    rank = rank - (rank >> 31);
    *(s32*)((u8*)yuwp + 0x1B4) = ((u32)rank & -((s32)(u32)rank >> 31) - 1U);
    rank = ((700 - *(s32*)((u8*)yuwp + 0xF8)) * 15);
    rank = rank / 700 + (rank >> 31);
    rank = rank - (rank >> 31);
    *(s32*)((u8*)yuwp + 0x1B8) = ((u32)rank & -((s32)(u32)rank >> 31) - 1U);
    rank = ((700 - *(s32*)((u8*)yuwp + 0xFC)) * 15);
    rank = rank / 700 + (rank >> 31);
    rank = rank - (rank >> 31);
    *(s32*)((u8*)yuwp + 0x1BC) = ((u32)rank & -((s32)(u32)rank >> 31) - 1U);
    ...
    *(s32*)((u8*)yuwp + 0x114) = 0x1E3AC;
    rank = (*(s32*)((u8*)yuwp + 0x104) - 0x1A9C8);
    rank = rank / 2000 + (rank >> 31);
    rank = rank - (rank >> 31);
    *(s32*)((u8*)yuwp + 0x1C4) = ((u32)rank & -((s32)(u32)rank >> 31) - 1U) + 7;
    rank = (*(s32*)((u8*)yuwp + 0x108) - 0x1A9C8);
    rank = rank / 2000 + (rank >> 31);
    rank = rank - (rank >> 31);
    *(s32*)((u8*)yuwp + 0x1C8) = ((u32)rank & -((s32)(u32)rank >> 31) - 1U) + 6;
    rank = (*(s32*)((u8*)yuwp + 0x10C) - 0x1A9C8);
    rank = rank / 2000 + (rank >> 31);
    rank = rank - (rank >> 31);
    *(s32*)((u8*)yuwp + 0x1CC) = ((u32)rank & -((s32)(u32)rank >> 31) - 1U) + 4;
    rank = (*(s32*)((u8*)yuwp + 0x110) - 0x1A9C8);
    rank = rank / 2000 + (rank >> 31);
    rank = rank - (rank >> 31);
    *(s32*)((u8*)yuwp + 0x1D0) = ((u32)rank & -((s32)(u32)rank >> 31) - 1U) + 4;
    rank = (*(s32*)((u8*)yuwp + 0x114) - 0x1A9C8);
    rank = rank / 2000 + (rank >> 31);
    rank = rank - (rank >> 31);
    *(s32*)((u8*)yuwp + 0x1D4) = ((u32)rank & -((s32)(u32)rank >> 31) - 1U) + 1;
    ...
    *(s32*)((u8*)yuwp + 0x12C) = 0x15950;
    rank = (*(s32*)((u8*)yuwp + 0x11C) - 74000);
    rank = rank / 2000 + (rank >> 31);
    rank = rank - (rank >> 31);
    *(s32*)((u8*)yuwp + 0x1DC) = ((u32)rank & -((s32)(u32)rank >> 31) - 1U) + 7;
