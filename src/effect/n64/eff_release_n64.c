...
void effReleaseDisp(s32 cameraId, void* effect) {
    ...
    extern f32 float_32_80425ecc;
    extern f32 float_64_80425ed0;
    extern f32 float_96_80425ed4;
    u8* work = *(u8**)((s32)effect + 0xC);
    ...
    for (i = 0; i < 4; i++) {
        ...
        if (i == 0) {
            ...
            PSMTXTrans(trans, 0.0f, 0.0f, 0.0f);
            ...
            PSMTXScale(scale, 0.00390625f, 0.00390625f, 0.0f);
            PSMTXTrans(trans, 0.0f, float_32_80425ecc, 0.0f);
            PSMTXConcat(scale, trans, scale);
            GXLoadTexMtxImm(scale, 0x1E, 1);
            GXBegin(0x90, 0, 12);
            tri2(4, 5, 6, 4, 4, 6, 7, 0);
            tri2(0x18, 0x19, 0x1A, 0x18, 0x18, 0x1A, 0x1B, 0);
            PSMTXScale(scale, 0.00390625f, 0.00390625f, 0.0f);
            PSMTXTrans(trans, 0.0f, float_64_80425ed0, 0.0f);
            PSMTXConcat(scale, trans, scale);
            GXLoadTexMtxImm(scale, 0x1E, 1);
            GXBegin(0x90, 0, 12);
            tri2(8, 9, 10, 8, 8, 10, 0xB, 0);
            tri2(0x14, 0x15, 0x16, 0x14, 0x14, 0x16, 0x17, 0);
            PSMTXScale(scale, 0.00390625f, 0.00390625f, 0.0f);
            PSMTXTrans(trans, 0.0f, float_96_80425ed4, 0.0f);
            PSMTXConcat(scale, trans, scale);
            GXLoadTexMtxImm(scale, 0x1E, 1);
            GXBegin(0x90, 0, 12);
            tri2(0xC, 0xD, 0xE, 0xC, 0xC, 0xE, 0xF, 0);
            tri2(0x10, 0x11, 0x12, 0x10, 0x10, 0x12, 0x13, 0);
        } else if (i == 2) {
