...
void effKemuri8Disp(s32 cameraId, void* effect) {
    ...
    extern u32 dat_80425798;
    extern f32 float_0p8_804257b0;
    extern f32 float_0p4_804257b4;
    extern f32 float_32_804257b8;
    extern f32 float_24_804257bc;
    extern f32 float_0p5_804257c0;
    extern u32 unk_80429718;
    ...
    s32 value;
    f32 size;
    f32 half = float_0p5_804257c0;
    f32 u0 = 0.0625f * (f32)*(s32*)(w + 0x40);
    f32 u1 = 0.0625f * (f32)*(s32*)(w + 0x48);
    volatile f32* fifo = (volatile f32*)0xCC008000;

    PSMTXTrans(m, *(f32*)(w + 4), *(f32*)(w + 8), *(f32*)(w + 0xC));
    PSMTXRotRad(r, 0x79, -*(f32*)((u8*)cam + 0x114) * 0.0174533f);
    ...
    GXSetTevColorIn(2, 0, 0, 10, 15);
    GXSetTevAlphaIn(2, 0, 0, 5, 7);
    GXSetCullMode(0);
    GXClearVtxDesc();
    GXSetVtxDesc(9, 1);
    GXSetVtxDesc(0xD, 1);
    ...
    for (i = 1; i < *(s32*)((u8*)effect + 8); i++, p += 0x5C) {
        if (*(s32*)(p + 0x40) >= 16) {
            continue;
        }
        ...
        for (j = 0; j < 2; j++) {
            if (j == 0) {
                color = (unk_80429718 & 0xFFFFFF00) |
                        (((u32)*(u8*)(p + 0x47) * 0x60) / 0xFF);
                GXSetChanMatColor(4, &color);
                PSMTXTrans(m, *(f32*)(p + 4) + 2.0f,
                              *(f32*)(p + 8) - 2.0f,
                              *(f32*)(p + 0xC));
            } else {
                if (*(s32*)(p + 0x50) != 0) {
                    s32 blue = 0xFF - (*(s32*)(p + 0x54) * 60);
                    s32 green = 0xFF;
                    s32 red = 0xFF;
                    if (blue < 0) {
                        green = 0xFF + (s32)(float_0p8_804257b0 * (f32)blue);
                        blue = 0;
                        if (green < 0) {
                            red = 0xFF + (s32)(float_0p4_804257b4 * (f32)green);
                            green = 0;
                            if (red < 0) {
                                red = 0;
                            }
            ...
            GXLoadPosMtxImm(m, 0);
            GXBegin(0x80, 0, 4);
            size = type ? float_32_804257b8 : float_24_804257bc;
