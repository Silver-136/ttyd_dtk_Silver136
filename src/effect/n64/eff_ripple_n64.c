...
void effRippleMain(void* effect) {
    ...
    *(s32*)(work + 0x20) += 1;
    ...
    if (timer > 5) {
        *(s32*)(work + 0x18) =
            (s32)((f32)(120 - *(s32*)(work + 0x18)) * float_0p3_80425f30 + (f32) * (s32*)(work + 0x18));
    }
    if (((u32)(type - 1) <= 1 || type == 3) && timer == 15) {
        child = effRippleN64Entry(type * 10, *(f32*)(work + 4), *(f32*)(work + 8), *(f32*)(work + 0xC),
                                  float_0_80425f20);
...
void effRippleDisp(s32 cameraId, void* effect) {
    ...
    extern f32 float_0p0625_80425f1c, float_0_80425f20, float_0p03125_80425f24, float_deg2rad_80425f28,
        float_1_80425f2c;
    u8 texObj[0x20];
    f32 base[3][4], rot[3][4], scale[3][4], mtx[3][4];
    u8* work = *(u8**)((s32)effect + 0xC);
    s32 type = *(s32*)work;
    u32 color;
    if (type == 10 || type == 20 || (type >= 1 && type <= 3) || type == 30)
        effGetTexObj(0x5B, texObj);
    else
        effGetTexObjN64(0x21, texObj);
    GXLoadTexObj(texObj, 0);
    effGetTexObjN64(0x22, texObj);
    GXLoadTexObj(texObj, 1);
    GXSetNumChans(0);
    GXSetNumTexGens(2);
    GXSetTexCoordGen2(0, 1, 4, 0x1E, 0, 0x7D);
    GXSetTexCoordGen2(1, 1, 4, 0x21, 0, 0x7D);
    PSMTXScale(scale, float_0p0625_80425f1c, float_0p0625_80425f1c, float_0_80425f20);
    ...
    GXSetTevAlphaIn(0, 0, 7, 1, 7);
    color = *(u32*)(work + 0x18);
    GXSetTevColor(1, &color);
    PSMTXScale(scale, float_0p03125_80425f24, float_0p03125_80425f24, float_0_80425f20);
    PSMTXTrans(rot, float_0_80425f20, (f32) * (s32*)(work + 0x24), float_0_80425f20);
    PSMTXConcat(scale, rot, scale);
    GXLoadTexMtxImm(scale, 0x21, 1);
    PSMTXTrans(mtx, *(f32*)(work + 4), *(f32*)(work + 8), *(f32*)(work + 0xC));
    PSMTXRotRad(rot, 0x78, float_deg2rad_80425f28 * *(f32*)(work + 0x2C));
    PSMTXConcat(mtx, rot, mtx);
    PSMTXRotRad(rot, 0x7A, float_deg2rad_80425f28 * *(f32*)(work + 0x30));
    PSMTXConcat(mtx, rot, mtx);
    PSMTXScale(scale, *(f32*)(work + 0x14) * *(f32*)(work + 0x10), float_1_80425f2c,
               *(f32*)(work + 0x14) * *(f32*)(work + 0x10));
    PSMTXConcat(mtx, scale, mtx);
    PSMTXConcat((void*)((s32)camGetPtr(cameraId) + 0x11C), mtx, mtx);
    GXLoadPosMtxImm(mtx, 0);
    GXSetCurrentMtx(0);
    GXSetCullMode(0);
    effSetVtxDescN64((void*)0x803A8008);
    GXBegin(0x90, 0, 6);
