...
void* effKemuri5N64Entry(f32 x, f32 y, f32 z, f32 angle) {
    ...
    *(void**)((s32)entry + 0x10) = effKemuri5Main;
    zero = float_0_804256d8;
    one = float_1_80425704;
    angleOffset = 0;
    p03 = float_0p03_80425708;
    p17 = float_1p7_8042570c;
    p05 = float_0p5_80425710;
    neg02 = float_neg0p02_80425714;
    p00005 = float_5Eneg05_80425718;
    neg39 = float_neg3p9_8042571c;
    six2832 = float_6p2832_804256e4;
    three60 = float_360_804256e8;
    for (i = 0; i < 8; i++) {
        *(s32*)part = 1;
        *(u8*)(part + 8) = 0xFF;
        *(s16*)(part + 6) = 0x1E;
        ...
        *(f32*)(part + 0x1C) = one;
        *(f32*)(part + 0x20) = one;
        *(f32*)(part + 0x24) = p03 * (f32)(rand() % 11) + one;
        *(f32*)(part + 0x28) = p03 * (f32)(rand() % 11) + p17;
        *(f32*)(part + 0x2C) = (f32)(rand() % 61);
        *(f32*)(part + 0x30) = neg39;
        *(f32*)(part + 0x34) = p05;
        *(f32*)(part + 0x38) = neg02;
        *(f32*)(part + 0x3C) = p00005;
        *(f32*)(part + 0x40) = zero;
        rad = reviseAngle(angle + (f32)angleOffset) * six2832 / three60;
        *(f32*)(part + 0x44) = (f32)sin(rad);
        *(f32*)(part + 0x48) = (f32)cos(rad);
        angleOffset += 45;
        part += 0x4C;
    }
    return entry;
...
const f32 vec3_802fb240[3] = { 0.0f, 0.0f, 0.0f };
const char str_Kemuri5N64_802fb24c[] = "Kemuri5N64";
