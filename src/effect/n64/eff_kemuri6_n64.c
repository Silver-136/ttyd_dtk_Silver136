...
void* effKemuri6N64Entry(s32 type, f32 x, f32 y, f32 z) {
    ...
    *(void**)((s32)entry + 0x10) = effKemuri6Main;
    ...
    zero = float_0_80425728;
    one = float_1_80425748;
    p03 = float_0p03_80425750;
    magic11 = 0x2E8BA2E9;
    magic61 = 0x4325C53F;
    magic361 = 0x5AC5242B;
    *(s32*)work = 1;
    ...
    *(f32*)(work + 0x44) = zero;
    *(f32*)(work + 0xC) = x;
    p14 = float_1p4_8042574c;
    *(f32*)(work + 0x10) = y;
    p15 = float_1p5_80425754;
    *(f32*)(work + 0x14) = z;
    two = float_2_80425758;
    neg05 = float_neg0p5_8042575c;
    *(f32*)(work + 0x1C) = one;
    *(f32*)(work + 0x20) = one;
    *(f32*)(work + 0x24) = one;
    *(u8*)(work + 8) = 0xFF;
    random = rand();
    quotient = __mulhw(magic11, random) >> 1;
    quotient += (u32)quotient >> 31;
    *(f32*)(work + 0x28) = p14 + p03 * (f32)(random - quotient * 11);
    random = rand();
    quotient = __mulhw(magic11, random) >> 1;
    quotient += (u32)quotient >> 31;
    *(f32*)(work + 0x2C) = p15 + p03 * (f32)(random - quotient * 11);
    random = rand();
    quotient = __mulhw(magic61, random) >> 4;
    quotient += (u32)quotient >> 31;
    *(f32*)(work + 0x30) = (f32)(random - quotient * 61);
    *(s16*)(work + 4) = (s16)type;
    *(f32*)(work + 0x38) = two;
    *(f32*)(work + 0x3C) = neg05;
    *(s16*)(work + 6) = 0xF;
    random = rand();
    quotient = __mulhw(magic361, random) >> 7;
    quotient += (u32)quotient >> 31;
    *(f32*)(work + 0x18) = (f32)(random - quotient * 0x169);
    *(u8*)(work + 8) = 0xFF;
