...
void effOpukuWcurtainMain(void* effect) {
    ...
    *(s32*)(work + 0x14) += 1;
    ...
    for (i = 0; i < 3; i++, p += 0x10) {
        ...
        *(f32*)(p + 0x30) += *(f32*)(p + 0x60);
        *(f32*)(p + 0x60) += float_neg0p05_80425bac;
        v = *(f32*)(p + 0x60);
        if (v > float_5_80425bb0) {
            *(f32*)(p + 0x60) = v + float_0p1_80425b98 * (float_5_80425bb0 - v);
        }

        *(f32*)(p + 0x34) += *(f32*)(p + 0x64);
        *(f32*)(p + 0x64) += float_neg0p05_80425bac;
        v = *(f32*)(p + 0x64);
        if (v > float_5_80425bb0) {
            *(f32*)(p + 0x64) = v + float_0p1_80425b98 * (float_5_80425bb0 - v);
        }

        *(f32*)(p + 0x38) += *(f32*)(p + 0x68);
        *(f32*)(p + 0x68) += float_neg0p05_80425bac;
        v = *(f32*)(p + 0x68);
        if (v > float_5_80425bb0) {
            *(f32*)(p + 0x68) = v + float_0p1_80425b98 * (float_5_80425bb0 - v);
        }
    }
...
void effOpukuWcurtainDisp(s32 cameraId, void* effect) {
    ...
    extern SmartAllocationData* smartAlloc(s32,s32); extern void PSMTXTrans(void*,f32,f32,f32); extern void PSMTXConcat(void*,void*,void*); extern void PSMTXMultVec(void*,void*,void*);
    ...
    work = *(u8**)((s32)effect + 0xC);
    *(u32*)&sourceColor = unk_80429788;
    sourceColor.r = *(u8*)(work + 0x18);
    sourceColor.g = *(u8*)(work + 0x1C);
    sourceColor.b = *(u8*)(work + 0x20);
    sourceColor.a = *(u8*)(work + 0x24);
    ...
    GXSetTevColorOp(0,0,0,0,1,0); GXSetTevAlphaOp(0,0,0,0,1,0); GXSetTevColorIn(0,2,0xC,8,0xF); GXSetTevAlphaIn(0,7,4,5,7);
    ...
    allocation = smartAlloc(0x2A0, 3);
    vertices = allocation->pMemory;
    vertex = vertices;
    x = -300;
    s = count << 5;
    fade = 0;
    ...
    for(i=0;i<count-1;i++){ s32 index=i*2; GXBegin(0x90,0,6); tri2(index,index+2,index+1,index,index+1,index+2,index+3,index); }
}
