...
void* effKemuri3N64Entry(f32 x, f32 y, f32 z, f32 angle) {
    ...
    *(void**)((s32)entry + 0x10) = effKemuri3Main;
    c0p3 = float_0p3_80425684;
    c0 = float_0_80425668;
    c1 = float_1_8042566c;
    angleOffset = 0;
    c1p75 = float_1p75_80425688;
    cNeg0p08 = float_neg0p08_8042568c;
    cNeg3p9 = float_neg3p9_80425690;
    c6p2832 = float_6p2832_80425694;
    c360 = float_360_80425698;
    ...
    for (i = 0; i < 5; i++) {
        ...
        *(s16*)(work + 6) = 0x3C;
        *(f32*)(work + 0x24) = c0;
        *(f32*)(work + 0x28) = angle + (f32)angleOffset;
        *(f32*)(work + 0x2C) = c0;
        *(f32*)(work + 0x70) = c1p75;
        *(f32*)(work + 0x74) = cNeg0p08;
        *(f32*)(work + 0x78) = c0;
        *(f32*)(work + 0x7C) = c0;
        *(f32*)(work + 0x60) = cNeg3p9;
        rad = c6p2832 * reviseAngle(*(f32*)(work + 0x28)) / c360;
