...
void effPacknBfireDisp(s32 cameraId, void* effect) {
    ...
    extern f64 sin(f64);
    extern f64 cos(f64);
    extern f32 float_deg2rad_80425c7c;
    extern f32 float_6p2832_80425c70;
    extern f32 float_360_80425c74;
    extern f32 float_128_80425c78;
    extern f32 float_0_80425c6c;
    ...
    if (*(s32*)part != 0) {
        u32 color1 = ((u8*)part)[0x28] << 24 | ((u8*)part)[0x2C] << 16 |
                     ((u8*)part)[0x30] << 8 | ((u8*)part)[0x34];
        u32 color2 = ((u8*)part)[0x38] << 24 | ((u8*)part)[0x2C] << 16 |
                     ((u8*)part)[0x40] << 8 | ((u8*)part)[0x44];
        ...
        GXSetTevColorIn(1, 0xF, 6, 8, 4);
        GXSetTevAlphaIn(1, 7, 2, 4, 3);
        GXSetTevOrder(2, 1, 1, 0xFF);
        GXSetTevColorOp(2, 1, 0, 0, 1, 0);
        GXSetTevAlphaOp(2, 1, 0, 0, 1, 0);
        GXSetTevColorIn(2, 0xF, 6, 6, 0);
        GXSetTevAlphaIn(2, 7, 1, 2, 0);
        GXSetTevOrder(3, 1, 1, 0xFF);
        GXSetTevColorOp(3, 0, 0, 0, 0, 0);
        GXSetTevAlphaOp(3, 0, 0, 0, 0, 0);
        GXSetTevColorIn(3, 0xF, 0, 8, 2);
        GXSetTevAlphaIn(3, 7, 0, 3, 7);
        GXSetTevOrder(4, 1, 1, 0xFF);
        GXSetTevColorOp(4, 1, 0, 0, 1, 0);
        GXSetTevAlphaOp(4, 0, 0, 0, 1, 0);
        GXSetTevColorIn(4, 0xF, 6, 8, 0);
        ...
        *(f32*)(part + 0x50) += *(f32*)(part + 0x58);
        {
            ...
            f32 angle = (f32)angleABf(zero, zero, *(f32*)(part + 0x60), *(f32*)(part + 0x64));
            f32 radians = float_6p2832_80425c70 * (*(f32*)(part + 0x74) - angle) /
                          float_360_80425c74;
            *(f32*)(part + 0x54) = (f32)sin(radians);
            *(f32*)(part + 0x58) = (f32)cos(radians);
        }
        if (*(f32*)(part + 0x4C) < float_0_80425c6c) {
            *(f32*)(part + 0x4C) += float_128_80425c78;
        }
