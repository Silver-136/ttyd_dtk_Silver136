...
void* effRadiationN64Entry(f32 x, f32 y, f32 z, f32 scale, s32 type) {
    ...
    *(s32*)entry |= 2;
    for (i = 0; i < count; i++, work += 0x9C) {
        ...
        *(s32*)(work + 0x28) = 100;
        *(s32*)(work + 0x2C) = 0;
        *(f32*)(work + 0xC4) = float_0_80425e1c;
        *(f32*)(work + 0xC8) = float_neg0p6_80425e40;
        *(f32*)(work + 0xD8) = float_10_80425e44;
        *(f32*)(work + 0xF0) = float_0p6_80425e48;
        *(f32*)(work + 0x124) = float_0p1_80425e4c;
        *(f32*)(work + 0x128) = float_2p5_80425e50;
        *(f32*)(work + 0x108) = (f32)effTblRandN64(0xB4, i * 3);
    }
    return entry;
}
...
void effRadiationMain(void* effect) {
    ...
    extern f32 float_256_80425e3c, float_0_80425e1c, float_neg0p6_80425e40, float_10_80425e44,
        float_0p6_80425e48, float_0p1_80425e4c;
    u8* work = *(u8**)((s32)effect + 0xC);
    s32 type = *(s32*)work, i, timer;
    ...
    *(s32*)(work + 0x2C) += 1;
    ...
    for (i = 1; i < *(s32*)((s32)effect + 8); i++, work += 0x9C) {
        ...
        *(s32*)(work + 0xC8) += 1;
        if (type < 2) {
            if (*(s32*)(work + 0xC8) < 10)
                *(s32*)(work + 0xC0) = *(s32*)(work + 0xC8) * 12;
            if (*(s32*)(work + 0xC4) < 1) {
                *(f32*)(work + 0xF4) = (f32)effTblRandN64(0xB4, i * 3);
                *(f32*)(work + 0xF8) = (f32)effTblRandN64(0xB4, i * 3 + 1);
                *(f32*)(work + 0xFC) = (f32)effTblRandN64(0xB4, i * 3 + 2);
                *(f32*)(work + 0xF4) = *(f32*)(work + 0x104);
                *(s32*)(work + 0xC4) = *(s32*)(work + 0x118);
                *(s32*)(work + 0xC8) = 0;
            }
        }
        else {
            *(f32*)(work + 0xD0) += *(f32*)(work + 0xE4);
            if (*(f32*)(work + 0xD0) > float_256_80425e3c)
                *(f32*)(work + 0xD0) -= float_256_80425e3c;
            if (*(f32*)(work + 0xD0) < float_0_80425e1c)
                *(f32*)(work + 0xD0) += float_256_80425e3c;
            *(s32*)(work + 0xC4) -= 1;
            *(s32*)(work + 0xC8) += 1;
        }
    }
    dispEntry(4, 2, effRadiationDisp, effect, dispCalcZ(*(u8**)((s32)effect + 0xC) + 0x10));
}
