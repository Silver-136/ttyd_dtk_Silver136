...
void* effKemuri4N64Entry(s32 type, f32 x, f32 y, f32 z, f32 angle, f32 side) {
    ...
    *(void**)((s32)entry + 0x10) = effKemuri4Main;
    zero = float_0_804256a8;
    one = float_1_804256b0;
    five4 = float_5p4_804256b4;
    half = float_0p5_804256b8;
    neg0p07 = float_neg0p07_804256bc;
    p003 = float_0p003_804256c0;
    six2832 = float_6p2832_804256c4;
    three60 = float_360_804256c8;
    ...
    *(f32*)(work + 0x68) = one;
    *(f32*)(work + 0x64) = five4;
    *(f32*)(work + 0x60) = side != zero ? -10.0f : 10.0f;
    *(f32*)(work + 0x70) = half;
    *(f32*)(work + 0x74) = neg0p07;
    *(f32*)(work + 0x78) = p003;
    *(f32*)(work + 0x7C) = zero;
    *(s16*)(work + 6) = 0xF;
    *(f32*)(work + 0x28) = angle;
    ...
    *(u8*)(work + 9) = (u8)(((rand() % 100) >> 4) & 1);
    rad = six2832 * reviseAngle(angle + (side != zero ? -90.0f : 90.0f)) / three60;
