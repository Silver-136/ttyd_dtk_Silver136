...
void* effRubbleN64Entry(s32 type, s32 lifetime, f32 x, f32 y, f32 z, f32 groundY, f32 vy, f32 gravity, f32 scale) {
    ...
    *(s32*)(work + 0x4C) = 0;
    *(f32*)(work + 0x14) = float_0_80425fbc;
    *(f32*)(work + 0x1C) = float_0_80425fbc;
    *(f32*)(work + 0x24) = float_0_80425fbc;
    *(f32*)(work + 0x28) = (f32)(rand() % 360);
    *(f32*)(work + 0x2C) = (f32)(rand() % 360);
    *(f32*)(work + 0x30) = float_0_80425fbc;
    *(f32*)(work + 0x38) = float_20_80425fc0;
    *(f32*)(work + 0x34) = float_neg20_80425fc4;
    *(s32*)(work + 0x44) = 0xFF;
    *(f32*)(work + 0x3C) = float_2_80425fc8 * scale;
    *(s32*)(work + 0x40) = 0;
    return entry;
}
