...
void* effRubbleN64Entry(s32 type, s32 lifetime, f32 x, f32 y, f32 z, f32 groundY, f32 vy, f32 gravity, f32 scale) {
    ...
    *(f32*)(work + 0x30) = float_0_80425fbc;
...
void effRubbleDisp(s32 cameraId, void* effect) {
    ...
    if (type == 0 || type == 3) {
        effSetVtxDescN64((void*)0x803A82B8);GXBegin(0x90,0,0x1E);
        tri2(0,1,2,0,3,4,5,0);tri2(6,7,8,0,9,10,11,0);tri2(12,13,14,0,15,16,17,0);tri2(18,19,20,0,21,22,23,0);tri2(24,25,26,0,27,28,29,0);
    } else if (type == 1 || type == 4) {
        effSetVtxDescN64((void*)0x803A8272);GXBegin(0x90,0,0x12);
        tri2(0,1,2,0,1,3,2,0);tri2(1,0,4,0,1,4,3,0);tri2(4,0,2,0,3,4,2,0);
    } else if (type == 2 || type == 5) {
        effSetVtxDescN64((void*)0x803A8130);GXBegin(0x90,0,0x1E);
        tri2(0,1,2,0,2,3,4,0);tri2(5,6,7,0,5,7,8,0);tri2(9,10,11,0,12,13,14,0);tri2(12,14,15,0,16,17,18,0);tri2(19,20,21,0,19,21,22,0);
    }
}
