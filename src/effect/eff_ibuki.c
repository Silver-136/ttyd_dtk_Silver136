...
/*
 * Renderer data catalog.  These definitions stay after the functions so the
 * existing function-local declarations retain their original compiler view.
 */
static f32 ibuki_sign_table0[] = {
    -1.0f, 1.0f, 1.0f, -1.0f,
};

static f32 ibuki_sign_table1[] = {
    1.0f, -1.0f, -1.0f, 1.0f,
};

static f32 ibuki_sign_table2[] = {
    -1.0f, 1.0f, 1.0f, -1.0f,
};

static f32 ibuki_sign_table3[] = {
    1.0f, -1.0f,
};

u8 ibuki_vertex_tbl[90] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0F, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x1D, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x45, 0xFF,
    0x00, 0x00, 0x00, 0x00, 0x55, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x0F, 0x00, 0x05, 0x00,
    0x00, 0x00, 0x1D, 0xFF, 0x05, 0x00, 0x00, 0x00, 0x45, 0xFF,
    0x05, 0x00, 0x00, 0x00, 0x55, 0x00, 0x05, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x0A, 0x00, 0x00, 0x00, 0x0F, 0x00, 0x0F, 0x00,
    0x00, 0x00, 0x1D, 0xFF, 0x14, 0x00, 0x00, 0x00, 0x45, 0xFF,
    0x23, 0x00, 0x00, 0x00, 0x55, 0x00, 0x28, 0x00, 0x00, 0x00,
};

static u8 ibuki_vertex_padding[6] = { 0 };

u8 ibuki_texcoord0_tbl[60] = {
    0x00, 0x00, 0x20, 0x00, 0x0B, 0x4B, 0x2C, 0xCC, 0x0B, 0x4B,
    0x40, 0x00, 0x00, 0x00, 0x40, 0x00, 0x16, 0x96, 0x33, 0x33,
    0x16, 0x96, 0x40, 0x00, 0x34, 0xB4, 0x38, 0x00, 0x34, 0xB4,
    0x40, 0x00, 0x40, 0x00, 0x38, 0x00, 0x40, 0x00, 0x40, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x0B, 0x4B, 0x00, 0x00, 0x16, 0x96,
    0x00, 0x00, 0x34, 0xB4, 0x00, 0x00, 0x40, 0x00, 0x00, 0x00,
};

static u8 ibuki_texcoord0_padding[4] = { 0 };

u8 ibuki_texcoord1_tbl[60] = {
    0x00, 0x00, 0x20, 0x00, 0x0B, 0x4B, 0x2C, 0xCC, 0x0B, 0x4B,
    0x40, 0x00, 0x00, 0x00, 0x40, 0x00, 0x16, 0x96, 0x33, 0x33,
    0x16, 0x96, 0x40, 0x00, 0x34, 0xB4, 0x38, 0x00, 0x34, 0xB4,
    0x40, 0x00, 0x40, 0x00, 0x38, 0x00, 0x40, 0x00, 0x40, 0x00,
...
static u8 ibuki_texcoord1_padding[4] = { 0 };

u8 ibuki_dl_0_0[64] = {
    0x98, 0x00, 0x06, 0x0A, 0x00, 0x00, 0x0A, 0x0A,
    0x0B, 0x00, 0x02, 0x0B, 0x0B, 0x05, 0x00, 0x00,
    0x00, 0x00, 0x06, 0x00, 0x01, 0x01, 0x01, 0x00,
    0x00, 0x00, 0x03, 0x03, 0x01, 0x00, 0x00, 0x02,
    0x02,
};

u8 ibuki_dl_0_1[64] = {
    0x98, 0x00, 0x06, 0x0B, 0x00, 0x02, 0x0B, 0x0B,
    0x0C, 0x00, 0x03, 0x0C, 0x0C, 0x06, 0x00, 0x01,
    0x01, 0x01, 0x07, 0x00, 0x01, 0x04, 0x04, 0x01,
    0x00, 0x00, 0x02, 0x02, 0x02, 0x00, 0x00, 0x05,
    0x05,
};

u8 ibuki_dl_0_2[64] = {
    0x98, 0x00, 0x06, 0x0C, 0x00, 0x03, 0x0C, 0x0C,
    0x0D, 0x00, 0x01, 0x0D, 0x0D, 0x07, 0x00, 0x01,
    0x04, 0x04, 0x08, 0x00, 0x01, 0x06, 0x06, 0x02,
    0x00, 0x00, 0x05, 0x05, 0x03, 0x00, 0x00, 0x07,
    0x07,
};

u8 ibuki_dl_0_3[64] = {
    0x98, 0x00, 0x06, 0x0D, 0x00, 0x01, 0x0D, 0x0D,
    0x0E, 0x00, 0x00, 0x0E, 0x0E, 0x08, 0x00, 0x01,
    0x06, 0x06, 0x09, 0x00, 0x00, 0x08, 0x08, 0x03,
    0x00, 0x00, 0x07, 0x07, 0x04, 0x00, 0x00, 0x09,
    0x09,
};

u8 ibuki_normal_tbl[32] = {
    0x00, 0x00, 0x40,
};

u8 ibuki_color0_tbl[16] = {
    0xFF, 0xFF, 0xFF, 0x00,
    0xFF, 0xFF, 0xFF, 0x66,
    0xFF, 0xFF, 0xFF, 0x4C,
    0xFF, 0xFF, 0xFF, 0x7F,
