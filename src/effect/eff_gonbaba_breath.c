...
void effGonbabaBreathMain(void* effect) {
    ...
    u32 position[3];
    s32 i;
    position[0]=vec3_80302b78[0]; position[1]=vec3_80302b78[1]; position[2]=vec3_80302b78[2];
    *(f32*)&position[0]=*(f32*)(base+4); *(f32*)&position[1]=*(f32*)(base+8); *(f32*)&position[2]=*(f32*)(base+0xC);
    if((*(u32*)entry&4)!=0) {
